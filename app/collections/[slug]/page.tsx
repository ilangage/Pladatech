  ...
  return (
    <ShopShell>
      <div className="subpage section-card">
          ...
          <h1 style={{ fontSize: "clamp(2.75rem, 5vw, 4rem)", lineHeight: 1.02, letterSpacing: "-0.04em", fontWeight: 800 }}>{col.name}</h1>
          <p style={{ color: "var(--muted)", maxWidth: 720, lineHeight: 1.65, fontWeight: 500, fontSize: 17 }}>{col.description}</p>
